...
#define REGEN_CURRENT_MAX_VALUE 15L
#define MOTOR_ROTOR_DELTA_PHASE_ANGLE_RIGHT 200
#define current_cal_a 71
#define LEVEL_1 40
#define LEVEL_2 40
#define LEVEL_3 40
#define LEVEL_4 40
...
#define ACA 4296
#define EEPROM_INIT_MAGIC_BYTE 109 // makes sure (chance of fail 1/255) eeprom is invalidated after flashing new config
